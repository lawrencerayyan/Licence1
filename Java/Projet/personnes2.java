   ...
   // choisir la taille de l'arene
    ...
    public void tour() {
        ...
        while (!gagnant()) {
            ...
            // affichage(tab_cache);
            // affichage(tab_cache);
            if (temp == 2) swap (arene , tab_cache);
    ...
    public  void swap(int arene[][], int tab_cache[][]) {
    ...
    public void chSwap(int arene[][], int tab_cache[][]) {
